...
void MinImage::load(std::array<double,9> lcell) {
  ...
  volume -= cell[0][1] * (cell[1][0]*cell[2][2] - cell[1][2] * cell[2][0]);
  volume += cell[0][2] * (cell[1][0]*cell[2][1] - cell[1][1] * cell[2][0]);

  invcell[0][0] = (1.0/volume) * (cell[1][1] * cell[2][2] - cell[1][2] * cell[2][1]);
  invcell[1][0] = (1.0/volume) * (cell[1][2] * cell[2][0] - cell[1][0] * cell[2][2]);
  invcell[2][0] = (1.0/volume) * (cell[1][0] * cell[2][1] - cell[1][1] * cell[2][0]);
  invcell[0][1] = (1.0/volume) * (cell[0][2] * cell[2][1] - cell[0][1] * cell[2][2]);
  invcell[1][1] = (1.0/volume) * (cell[0][0] * cell[2][2] - cell[0][2] * cell[2][0]);
  invcell[2][1] = (1.0/volume) * (cell[0][1] * cell[2][0] - cell[0][0] * cell[2][1]);
  invcell[0][2] = (1.0/volume) * (cell[0][1] * cell[1][2] - cell[0][2] * cell[1][1]);
  invcell[1][2] = (1.0/volume) * (cell[0][2] * cell[1][0] - cell[0][0] * cell[1][2]);
  invcell[2][2] = (1.0/volume) * (cell[0][0] * cell[1][1] - cell[0][1] * cell[1][0]);
};
